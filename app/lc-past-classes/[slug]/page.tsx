...
import { getClassBySlug, getAllClasses } from "@/lib/classUtils";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${classItem.year} | Leadership C.O.N.N.E.C.T.I.O.N.S.`,
    description: classItem.paragraph,
  };
}
...
export default async function ClassDetailPage({ params }: Props) {
  ...
  const { title, image, year, graduationDate, tags, content } = classItem;
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-gray-300 pb-4">
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          Class Year: <span className="font-bold">{year}</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div
                    className="blog-details prose prose-lg max-w-none text-gray-900"
