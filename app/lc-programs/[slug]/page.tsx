...
import { getProgramBySlug, getAllPrograms } from "@/lib/programUtils";
...
export async function generateMetadata({
  ...
  return {
    title: `${program.title} | Leadership C.O.N.N.E.C.T.I.O.N.S.`,
    description: program.paragraph,
  };
}
...
const ProgramDetailsPage = ({ params }: { params: { slug: string } }) => {
  const program = getProgramBySlug(params.slug);
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-primary-600 dark:text-primary-400 sm:text-4xl sm:leading-tight relative z-10">
                  {program.title}
                </h2>
