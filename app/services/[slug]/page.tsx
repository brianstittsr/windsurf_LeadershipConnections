...
import { getServiceBySlug, getAllServices } from "@/lib/serviceUtils";
...
export async function generateMetadata({
  ...
  return {
    title: `${service.title} | Leadership C.O.N.N.E.C.T.I.O.N.S.`,
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight relative z-10">
                  {service.title}
                </h2>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <span className="inline-block rounded bg-primary px-4 py-1 text-xs font-semibold uppercase tracking-wide text-white">
                      {service.tags[0]}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="mt-12 p-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="mb-6 text-base text-body-color">
                        Book an appointment to learn more about this service and how it can benefit you or your organization.
                      </p>
                      <Link
                        href="/admin/registration"
                        className="inline-flex items-center justify-center rounded-md bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-opacity-90"
                      >
                        Book an Appointment
                      </Link>
                    </div>
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex items-center sm:justify-end">
                        {service.tags.map((tag, index) => (
                          <span
                            key={index}
                            className="mr-3 inline-block rounded bg-primary px-4 py-1 text-xs font-semibold uppercase tracking-wide text-white"
                          >
                            {tag}
                          </span>
                        ))}
